...
function deleteComment(url, request) {
  ...
  let authorCommentId = database.users[savedComment.username].commentIds;
  authorCommentId.splice(authorCommentId.indexOf(id), 1);
  let articleCommentId = database.articles[savedComment.articleId].commentIds;
